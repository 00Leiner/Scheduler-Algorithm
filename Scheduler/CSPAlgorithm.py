...
class CSPAlgorithm:
    ...
    def update_Schedule(self, assignment):
        ...
        updateSchedule(assignment, self.BlockSchedule, self.InstructorSchedule, self.RoomSchedule)
    ...
    def order_domain_value(self, variable, assignment):
        ...
        sorted_domain_values = sorted(domain_values, key=lambda value: self.heuristic_function(value, variable, assignment))
